...
models_path = Path(Path(__file__).resolve().parent.parent.parent/"settings")
...
class AudioTranscriber:
    MODEL_PATH = models_path/"/ASR/nemo-parakeet_tdt_ctc_110m.onnx"
    TOKEN_PATH = models_path/"models/ASR/nemo-parakeet_tdt_ctc_110m_tokens.txt"
